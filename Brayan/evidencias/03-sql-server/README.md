# 📘 Evidencias de Implementación y Consultas DML: SQL Server 2022 (Motor 3)
...
Se desplegaron las 16 tablas correspondientes al modelo RBAC y al dominio ClimaTec dentro del esquema `dbo` de SQL Server.
...
3. **Búsqueda por Patrón de Texto (`LIKE`):**  
   ![WHERE LIKE](06_where_ilike.png)
...
2. **Paginación de Resultados (`TOP 3`):**  
  ![TOP](16_limit.png)
